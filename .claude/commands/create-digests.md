...
1. **Find First Unprocessed Transcript**
   ...
   - Also check legacy location `digests/YYYY-MM-DD.md` for backwards compatibility
...
3. **Handle Ambiguities**
   - If you encounter significant ambiguities (character identity, spelling variations, unclear events):
     ...
     - Examples: "Is 'Lyn' and 'Lynn' the same character?", "Does 'the dwarf' refer to Bruldin or Alrik?"
   ...
   - Wait for user clarification before finalizing the digest
